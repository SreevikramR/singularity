...
pub use available_wifi::{AccessPoint, NetworkType};
pub mod current_networks;
pub use current_networks::ActiveConnectionInfo;
pub mod devices;
pub mod hw_address;
...
use self::{
    available_wifi::handle_wireless_device,
    current_networks::active_connections,
};
